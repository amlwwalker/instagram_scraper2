      ...
      return function(rawPost) {
        ...
        switch (post.type) {
          case 'image':
            ...
            post.likes = []
            for (var i = 0; i < rawPost.likes.data.length; i++) {
              var userWhoLiked = {}
              userWhoLiked.id = rawPost.likes.data[i].id
              userWhoLiked.username = rawPost.likes.data[i].username
              userWhoLiked.profile_picture = rawPost.likes.data[i].profile_picture
